 ...
 ** Generated: 2020-05-26 11:55:02.357 +1000
 **/
...
public class XenatList extends RPCService {
	...
	private final static String WSWHIS02_FORMAT = // from IDL
			("OA(V)0,0SG(U)1,1,0SA1,0SA(V)0,0SA(V)0,0SA(V)0,0SG1,0OG1,"
					+ "1OA8,0OA(V)0,0OG1,0SG(U)1,1,0SA8,0SA10,0SA1,0ST0,0SA8,0SA8,"
					+ "0SI4,0SA1,0SA1,0ST0,0SA8,0SA8,0SI4,0SA8,0SG1,0.");
	...
	public void wswhis02(String _ptid, Wswhis02_criteria _criteria) throws BrokerException {
		...
		enterStub();
		buildHeader(WSWHIS02_FORMAT, "27", 0, 0, "WSWHIS02", true, 2000, true, true, 2050);
	...
	public class Wswhis02_criteria {
		...
		public void add() throws BrokerException {
			...
			if (_module == null) {
				...
				XenatList.super.marshal.addDataA(_module, 8);
			}

			if (_db == null) {
				XenatList.super.marshal.addDataAV(null);
			} else {
				XenatList.super.marshal.addDataAV(_db);
			}
		}
