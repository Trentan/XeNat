...
import com.xenat.app.rest.client.jersey.v1.invoker.ApiClient;
import com.xenat.app.rest.client.jersey.v1.invoker.ApiException;
import com.xenat.app.rest.client.jersey.v1.invoker.ApiResponse;
import com.xenat.app.rest.client.jersey.v1.invoker.Pair;
...
public class DefaultApiClient extends ApiClient {
	...
	private static final String AV_REST_URI = "xenat.rest.uri";
